    ...
    <div className="flex flex-col min-h-screen bg-background-light dark:bg-background-dark max-w-7xl mx-auto">
      ...
      <main className="flex-1 w-full max-w-[1440px] mx-auto px-6 py-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
          ...
          <button className="flex items-center gap-2 bg-primary hover:bg-primary-dark text-white font-bold py-3 px-6 rounded-lg transition-colors shadow-md shadow-primary/20 w-fit">
            <Plus size={20} />
